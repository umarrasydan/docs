...
<Tabs>
  ...
  <Tab title="Terminal API (C2C)">
    ...
    <ul>
      ...
      <li>Requires the Terminal Gateway App; BRI and NTT providers are not available without it.</li>
      <li>Exposes RESTful endpoints only—no SDKs for this API track.</li>
