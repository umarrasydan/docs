...
<CardGroup cols={2}>
<Card title="macOS (.dmg)" icon="apple" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/Xendit+Terminal+Gateway-1.3.0.dmg">
  Download the macOS installer (v1.3.0)
</Card>

<Card title="Windows (.msi)" icon="windows" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/Xendit+Terminal+Gateway-1.3.0.msi">
  Download the Windows installer (v1.3.0)
</Card>

<Card title="Android (.apk)" icon="android" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/Xendit+Terminal+Gateway-1.3.0.apk">
  Download the Android APK (v1.3.0)
</Card>
</CardGroup>
...
<Table>
  ...
  <TableBody>
    <TableRow>
      <TableCell>Unreachable/Offline</TableCell>
      <TableCell>Red</TableCell>
      <TableCell>
        EDC terminal is unreachable or offline due to incorrect IP address,
        network issues, or missing EDC configuration
      </TableCell>
    </TableRow>
    <TableRow>
    ...
    <TableRow>
      ...
      <TableCell>
        EDC terminal is online, connected, and ready for transactions
      </TableCell>
    </TableRow>
    <TableRow>
