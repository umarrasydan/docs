...
<CardGroup cols={1}>
<Card title="iOS SDK (v0.4.1)" icon="apple" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/TerminalGateway+iOS-0.4.1.zip">
  Download the complete iOS SDK package including TerminalGateway.xcframework and documentation

  ```
  SHA256: 1561b0f5f763791a613d0d356ebbfdf3a55db0693dc5fb72004bdc6ae5f895f1
  ```
</Card>
</CardGroup>
