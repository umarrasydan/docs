...
<CardGroup cols={1}>
<Card title="iOS SDK (v0.6.0)" icon="apple" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/TerminalGateway+iOS-0.6.0.zip">
  Download the complete iOS SDK package including TerminalGateway.xcframework and documentation

  ```
  SHA256: a77a2d07d5ea9e4dd0ce7be5cd7a50491b081e0f3b04e9e2a5277e697aebc602
  ```
</Card>
</CardGroup>
