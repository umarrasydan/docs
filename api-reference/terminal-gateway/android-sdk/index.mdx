...
<CardGroup cols={1}>
<Card title="Android SDK (v0.4.0)" icon="android" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/TerminalGateway+Android-0.4.0.zip">
  Download the complete Android SDK package including all dependencies and documentation

  SHA256: 89dec2e85133314c37c8989a1f4a80fd7c087ef6cd66460aaa3d92a863826dc1
</Card>
</CardGroup>
