...
<CardGroup cols={1}>
<Card title="Android SDK (v0.5.0)" icon="android" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/TerminalGateway+Android-0.5.0.zip">
  Download the complete Android SDK package including all dependencies and documentation

  ```
  SHA256: f3de8f73efc4aaf8b9fe3e05fe482fa0927ad953f157fd587a7665af94eebf96
  ```
</Card>
</CardGroup>
