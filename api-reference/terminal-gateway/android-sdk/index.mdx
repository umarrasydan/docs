...
<CardGroup cols={1}>
<Card title="Android SDK (v0.6.0)" icon="android" href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/TerminalGateway+Android-0.6.0.zip">
  Download the complete Android SDK package including all dependencies and documentation

  ```
  SHA256: 152f2d2d60943ba97ef682629d77068da03fa9201a5132e31a87378a57d51be5
  ```
</Card>
</CardGroup>
