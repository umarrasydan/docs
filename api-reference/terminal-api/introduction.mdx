...
<Warning>
**Gateway App Required**: For BRI and NTT terminals, you must install the Terminal Gateway application on your local device before using the Terminal API (H2H). Cashup terminals connect directly without requiring the gateway app. See the [Terminal Gateway App Configuration](/sdk/gateway/app-configuration) guide for installation and setup instructions.
</Warning>
...
The Terminal H2H is required to manage your terminal devices:

<Tabs>
<Tab title="Desktop App">
  **Available Platforms**: Windows, macOS
  
  Download and install the Terminal H2H desktop application:
...
<Tab title="Mobile SDK">
  **Available Platforms**: Android (Kotlin), iOS (Swift)
  ...
  Integrate the Terminal H2H SDK into your mobile application:
  ...
  <Tip>
  See our [Terminal H2H documentation](/sdk/h2h/introduction) for detailed integration guides.
  </Tip>
</Tab>
</Tabs>
...
<Card
  title="Retry Payment Session"
  icon="arrow-rotate-right"
  href="/api-reference/payments-terminal-api/retry-terminal-payment-session"
>
