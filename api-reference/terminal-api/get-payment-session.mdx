...
<ResponseField name="channel_properties.payment_methods" type="array">
  Valid Values: ID_INSERT_CARD, ID_TAP_CARD, ID_BRIZZI, ID_QRIS, VN_CARD, VN_QR, TH_ALIPAY_PLUS, TH_WECHATPAY, TH_TRUEMONEY, TH_LINEPAY, TH_SHOPEEPAY, TH_MAXME, TH_CARD, TH_MULTIIPP, TH_QRCODE
