...
<Step title="Run a test transaction">
  ...
  <Info>
  For SDK testing without hardware, either set `TerminalC2C.isSimulation = true` globally before issuing requests or pass `isSimulation = true` to the payment methods as shown above. Remove these simulation flags for real terminal runs.
  </Info>
</Step>
</Steps>
