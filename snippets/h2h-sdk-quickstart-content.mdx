...
<Step title="Register your terminal device(s)">
  Register devices in the SDK using your [Terminal ID (TID)](/sdk/gateway/app-configuration#finding-terminal-information) and [IP address](/sdk/gateway/app-configuration#finding-terminal-information).
  ...
  <Tip>
  If you don’t have these yet, follow the [Finding Terminal Information](/sdk/gateway/app-configuration#finding-terminal-information) guide.
  </Tip>
</Step>
</Steps>
