...
<Step title="Register your terminal device(s)">
  ...
  <Tab title="Android (Kotlin)">
    ```kotlin
    val devices = listOf(
      TerminalDevice(id = "TID001", ipAddress = "192.168.1.100", active = true),
      TerminalDevice(id = "TID002", ipAddress = "192.168.1.101", active = true)
    )
  ...
  <Tab title="iOS (Swift)">
    ```swift
    let devices = [
      TerminalDevice.companion.create(id: "TID001", ipAddress: "192.168.1.100"),
      TerminalDevice.companion.create(id: "TID002", ipAddress: "192.168.1.101")
    ]
