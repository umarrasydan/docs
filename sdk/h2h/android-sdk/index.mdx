...
<AccordionGroup>
  ...
  <Accordion title="v1.2.0 — 29-Apr-2026">
    What's new:
...
**Required dependency (Cashup provider-specific methods):**
```kotlin
...
### Cashup print receipt

If you integrate Cashup terminals, you can control whether the terminal prints a receipt after a transaction.

```kotlin
import co.xendit.terminal.cashup.utils.setPrintReceiptEnabled

// Enable receipt printing
TerminalH2H.setPrintReceiptEnabled(true)

// Disable receipt printing
TerminalH2H.setPrintReceiptEnabled(false)
```
