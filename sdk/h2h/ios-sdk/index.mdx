...
<Tab title="SHC Provider (Malaysia)">
```swift
// Add SHC provider for Malaysian terminals
TerminalH2H.shared.addProvider(provider: TerminalSHC.shared)
```

<Info>
SHC provider supports Share Commence terminals for the Malaysia market with card and QR payment capabilities.
</Info>
</Tab>
