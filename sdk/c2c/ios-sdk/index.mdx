...
func application(
  ...
  TerminalApp.shared.initialize(
    ...
    mode: .live // or .integration for testing
  )
...
### Step 3: Configure Terminal Device
  ...
  <Tab title="Provider-Specific Methods">
    ...
    <Note>
    Provider-specific methods are available in the iOS SDK without requiring additional dependencies. You can use `TerminalDevice.bri()`, `TerminalDevice.cashup()`, or `TerminalDevice.ntt()` directly.
    </Note>
  </Tab>
...
<Accordion title="Authentication Failed">
  ...
  **Solutions**:
  ...
  TerminalApp.shared.initialize(
    clientKey: CLIENT_KEY,
    mode: .live // use .integration for test environments
  )
  ```
</Accordion>
