...
<Info>
Terminal C2C works alongside the Terminal H2H to provide a complete in-person payment solution. You'll use Terminal C2C to interact with the local gateway service that communicates with physical payment devices.
</Info>
...
- Terminal H2H service running locally (default port 8189)
