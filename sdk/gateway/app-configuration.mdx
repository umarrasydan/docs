...
<AccordionGroup>
  <Accordion title="v1.9.0 — 29-Apr-2026">
    What's new:
...
<Card title="macOS (.dmg)" icon="apple">
  ...
  <a
    href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/Xendit+Terminal+Gateway-1.9.0.dmg"
...
<Card title="Windows (.msi)" icon="windows">
  ...
  <a
    href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/Xendit+Terminal+Gateway-1.9.0.msi"
    className="inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
  >
...
<Card title="Android (.apk)" icon="android">
  ...
  <a
    href="https://xnd-secops.s3.ap-southeast-1.amazonaws.com/inpersonpayments/Xendit+Terminal+Gateway-1.9.0.apk"
    className="inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
  >
...
<Step title="Open Settings and Enable Overlay">
  ...
  <Frame>
  <img src="/images/app/use-system-overlay.png" alt="Gateway app settings showing Use System Overlay toggle and Open Settings button" />
  </Frame>
</Step>
...
<Step title="Find Xendit App">
  ...
  <Frame>
  <img src="/images/app/finding-xendit.png" alt="Android system settings showing list of apps with Xendit app highlighted" />
  </Frame>
</Step>
...
<Step title="Enable Display Over Other Apps">
  ...
  <Frame>
  <img src="/images/app/enable-display-over-other.png" alt="Xendit app permission screen showing Allow display over other apps toggle" />
  </Frame>
...
<Step title="Open Settings and Configure Print Receipt">
  ...
  <Frame>
  <img src="/images/app/print-receipt.png" alt="Gateway app settings showing Print Receipt toggle for Cashup provider" />
  </Frame>
