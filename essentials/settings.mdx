...
description: 'Xendit documentation gives you complete control over the look and feel of your documentation using the docs.json file'
icon: 'gear'
---
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://docs.xendit.co`
    </ResponseField>
