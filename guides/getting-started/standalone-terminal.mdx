---
title: 'Standalone Payment Terminal'
...
Funds are settled into your **Xendit Balance** within **T+2 days** after the transaction settlement is completed on the device. You can view all transactions in the **Xendit Dashboard**.

<Info>
**BRI and NTT terminals**: If you are using BRI (Indonesia) or NTT (Thailand) terminals, these providers require the [Terminal Gateway App](/sdk/gateway/app-configuration) or the corresponding SDK to be pre-installed on your local device, even for standalone use. Other terminal providers support direct connection without any pre-install.
</Info>
